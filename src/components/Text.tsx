...
export const Text = ({ size, fontWeight = "normal", classNameText, text, type = "default", children, isTitle }: TextProps) => {
  const defaultText = "align-center self-center"
  const isTitleSize = isTitle ? "text-3xl md:text-4xl lg:text-5xl" : "md:text-xl lg:text-2xl";
