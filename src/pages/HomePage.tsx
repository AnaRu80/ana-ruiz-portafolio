...
export function HomePage() {
  ...
  return (
    <div className='h-full dark:bg-black ' >
      <div className="flex flex-col sm:flex-row px-4 mt-5 md:-mt-5 lg:-mt-10 xl:-mt-20 z-0 mb-5">
        <div className="flex flex-col text-justify justify-center sm:w-1/2">
          <Text size='xl' fontWeight='bold' text='Hello' classNameText="mr-auto mb-1 md:mb-2 " />
          <Text size='2xl' isTitle fontWeight='bold' text="I'm Ana" classNameText='mr-auto mb-2 md:mb-4' />
          <Text size='xl' fontWeight='bold' text={t('home.homeIntro')} classNameText=' lg:leading-10 ' />
        </div>
